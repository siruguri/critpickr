...
class MovieTest < ActiveSupport::TestCase
  ...
  test '#save_payload!' do
    ...
    assert_equal 3, @model.ratings.size
    assert_equal String, @model.ratings[0].class
  ...
  test '#uri' do
    assert_equal movies(:entry_1).original_uri, movies(:entry_1).uri
  end
